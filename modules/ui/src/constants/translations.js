...
export const translations = {
  vi: {
    ...
    confirm_body: 'Bạn có những thay đổi chưa lưu trong biểu mẫu. Bạn có chắc chắn muốn thoát không?',
    confirm_stay: 'Ở LẠI',
  ...
  en: {
    ...
    login_terminal: '> INITIALIZING_AUTH_PROTOCOL... \n> ACCESSING_MAINFRAME... \n> STATUS: ENCRYPTED \n> PLEASE_IDENTIFY_YOURSELF_',
