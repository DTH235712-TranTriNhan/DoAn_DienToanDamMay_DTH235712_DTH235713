    ...
    <div className="relative h-[350px] md:h-[480px] w-full overflow-hidden rounded-3xl mb-12 border border-white/10 shadow-2xl group">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <img
            src={currentEvent.imageUrl || "https://placehold.co/1200x600/090014/FF00FF?text=Hot+Event"}
              ...
              <div className="flex flex-wrap items-center gap-8">
                ...
                <div className="flex items-center gap-6 text-white/90">
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-black text-secondary/60 tracking-[0.2em]" style={{ fontFamily: TYPOGRAPHY.TECH }}>{t('card_location')}</span>
                    <span className="text-sm font-bold truncate max-w-[180px]">{currentEvent.location}</span>
                  </div>
                  <div className="w-px h-10 bg-white/20" />
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-black text-secondary/60 tracking-[0.2em]" style={{ fontFamily: TYPOGRAPHY.TECH }}>{t('card_date')}</span>
                    <span className="text-sm font-bold">
                      {new Date(currentEvent.date).toLocaleDateString(lang === 'vi' ? 'vi-VN' : 'en-US', {
      ...
      <div className="absolute top-0 right-0 w-40 h-40 pointer-events-none overflow-hidden opacity-50">
        ...
        <div className="absolute top-2 right-10 text-[8px] font-mono text-primary/40 tracking-widest vertical-text uppercase">HOT_EVENT_STREAM_V3.0</div>
      </div>
